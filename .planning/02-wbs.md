...
- [x] ADR-0004 인증 방식 작성
- [x] ADR-0005 AI API 제공자 작성
- [x] docs/testing.md, BONUS.md, AGENTS.md, task-b.md 작성

### 아키텍처 변경 (팀 결정)
- Supabase 제거 → Google AI Studio 직접 호출
...
- [x] `history_screen.dart` — 대화 기록 목록
- [x] `history_provider.dart` — 기록 상태 관리
- [x] `analysis_screen.dart` — 약점 분석 화면
- [x] `analysis_service.dart` — AnalysisAgent: Gemini API 호출
- [x] `analysis_provider.dart` — 분석 상태 관리
...
- [x] `auth_provider.dart` — authNotifierProvider 구현
- [x] `history_detail_screen.dart` — 과거 대화 상세 보기
- [x] JSON 파싱 오류 수정 (feedback, analysis maxOutputTokens 조정)
- [x] script.md 발표 대본 작성
- [x] briefing-12week.md 팀원 브리핑 문서
